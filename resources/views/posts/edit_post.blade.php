    ...
    <div class='flex-1 bg-gray-200 p-4'>
        <form action='/posts/{{$post->id}}' method='POST'>
            ...
            <div class="mt-12 mb-8">
                ...
                <span class="tag uppercase text-xs bg-green-50 p-0.5 border-gray-500 border rounded text-gray-700 font-medium" data-position="1" data-tag-id="{{ $category->tags[0]->id }}" @if($post->tag->position !== 1) style="display: none;" @endif>{{$category->tags[0]->name}}</span>
                <span class="tag uppercase text-xs bg-green-50 p-0.5 border-blue-500 border rounded text-blue-700 font-medium" data-position="2" data-tag-id="{{ $category->tags[1]->id }}" @if($post->tag->position !== 2) style="display: none;" @endif>{{$category->tags[1]->name}}</span>
                <span class="tag uppercase text-xs bg-green-50 p-0.5 border-green-500 border rounded text-green-700 font-medium" data-position="3" data-tag-id="{{ $category->tags[2]->id }}" @if($post->tag->position !== 3) style="display: none;" @endif>{{$category->tags[2]->name}}</span>
            </div>
            <div class='mt-12 mb-8'>
