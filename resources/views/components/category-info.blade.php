<div class="bg-gray-100 w-64 p-4 flex flex-col flex-shrink-0 md:w-50">
    <div class='sticky top-0 z-10'>
        ...
        <div class="flex justify-between mt-2 mx-2 items-center flex-row md:flex-col md:w-50">
        ...
        <div class='mt-4 border-4 border-double border-gray-500 rounded-lg p-2 text-center'>
