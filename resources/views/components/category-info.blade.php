    ...
    <div class='sticky top-0 z-10'>
        ...
        @else
            ...
            <form method='POST' action='{{route('unfollow', $category)}}'>
                ...
                @method('DELETE')
                <button type="submit" 
                        class="bg-gray-500 hover:bg-red-400 text-white font-bold text-center py-2 px-4 rounded-full w-full mt-4 mx-1 mb-3" 
            ...
            <form method='POST' action='{{route('follow', $category)}}'>
                @csrf
                <button type="submit" class="bg-gray-500 hover:bg-gray-600 text-white font-bold text-center py-2 px-4 rounded-full w-full mt-4 mx-1 mb-3">
                    Follow
                </button>
            </form>
            @endif
